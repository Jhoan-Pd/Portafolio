...
export default function Languages() {
  const section = usePortfolioSection('languages');
  const { language } = useLanguage();
  const rawItems = section?.items as LanguageItem[] | undefined;
  ...
  const title = section?.title?.toUpperCase() ?? (language === 'es' ? 'LENGUAJES' : 'LANGUAGES');
