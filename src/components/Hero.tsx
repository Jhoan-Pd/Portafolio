    ...
    <section className="relative w-full bg-[var(--page-bg)] text-[var(--page-fg)] transition-colors duration-300">
      ...
      >
        <div className="flex items-center justify-between gap-3 sm:gap-4">
          {/* Pastilla izquierda (autor) – CLARA en dark */}
          <div
            className="
              ...
              bg-[#102535] text-white
              dark:bg-neutral-100 dark:text-neutral-900 dark:ring-black/10
              transition-colors
            "
          >
            <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full overflow-hidden bg-slate-200 ring-2 ring-black/10 shrink-0">
              <Image
          ...
          {/* Pastilla derecha (acciones) – CLARA en dark */}
          <div
            className="
          ...
          >
            <button
              ...
              className="
                ...
                rounded-xl bg-white text-neutral-900 shadow hover:bg-neutral-100 transition
              "
      ...
      >
        ...
        />
        {/* Overlays */}
        <div className="absolute inset-0 bg-black/45 dark:bg-black/25" />
        <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/20 to-black/10 dark:from-black/20 dark:via-black/10 dark:to-black/0" />
      ...
      <div className="pointer-events-none absolute right-4 sm:right-6 bottom-4 sm:bottom-6 z-20">
        <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full shadow-lg backdrop-blur bg-white/80 text-neutral-900 ring-1 ring-black/10 transition-colors">
          {hero.author.badge}
        </div>
      </div>
    </section>
