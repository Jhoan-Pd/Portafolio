  ...
  return (
    <section className="relative w-full bg-[var(--page-bg)] text-[var(--page-fg)] transition-colors duration-300">
        ...
        <div className="flex items-center justify-between gap-3 sm:gap-4">
          ...
          <div
            className="
              ...
              bg-[#102535] dark:bg-[#0B2837] text-white transition-colors
            "
          >
          ...
          >
            <button
              ...
              className="
                ...
                rounded-xl bg-white text-neutral-900 shadow
      ...
      >
        ...
        {/* Overlays dependientes del tema */}
        <div className="absolute inset-0 bg-black/45 dark:bg-black/30" />
        <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/25 to-black/10 dark:from-black/25 dark:via-black/15 dark:to-black/5" />
      ...
      <div className="relative z-20 -mt-14 sm:-mt-20">
        <div
          className="
            ...
            bg-white/95 dark:bg-neutral-950/80
          ...
          <div className="mt-6 sm:mt-7 flex justify-center">
            <Link
              ...
              className="
                ...
                bg-[rgb(229,127,121)] dark:bg-[rgb(229,127,121)]
              "
            >
      ...
      <div className="pointer-events-none absolute right-4 sm:right-6 bottom-4 sm:bottom-6 z-20">
        <div className="flex h-12 w-12 sm:h-14 sm:w-14 items-center justify-center rounded-full shadow-lg backdrop-blur bg-white/75 text-neutral-900 ring-1 ring-black/10 dark:bg-white/10 dark:text-white dark:ring-white/20 transition-colors">
          {hero.author.badge}
        </div>
      </div>
    </section>
