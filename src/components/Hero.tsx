  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        "
      >
        {/* muestra ES/EN como texto corto para legibilidad */}
...
function ThemeMenu() {
  ...
  const icon = resolvedTheme === 'dark'
    ? (/* moon */ <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current"><path d="M21 12.79A9 9 0 1111.21 3a7 7 0 109.79 9.79z"/></svg>)
    : (/* sun  */ <svg viewBox="0 0 24 24" className="h-4 w-4 fill-current"><path d="M6.76 4.84l-1.8-1.79L3.17 4.84l1.79 1.79 1.8-1.79zM1 13h3v-2H1v2zm10 10h2v-3h-2v3zm9.83-18.16l-1.79-1.79-1.8 1.79 1.8 1.79 1.79-1.79zM20 13h3v-2h-3v2zM6.76 19.16l-1.8 1.79 1.42 1.42 1.79-1.79-1.41-1.42zM17.24 19.16l1.41 1.42 1.79-1.79-1.41-1.42-1.79 1.79zM12 6a6 6 0 100 12A6 6 0 0012 6z"/></svg>);
