...
export default function Hero() {
  ...
  if (!hero) {
    return (
      <section className="grid h-[60svh] min-h-[420px] place-items-center text-neutral-400">
  ...
  return (
    <section className="relative w-full theme-page transition-colors duration-300">
      <nav
        className="pointer-events-none fixed left-1/2 top-4 z-[60] w-full max-w-5xl -translate-x-1/2 px-4 sm:top-6 sm:px-6"
      ...
      >
        <Image
          ...
          alt={language === 'es' ? 'Imagen de fondo del héroe' : 'Hero background image'}
          fill
          priority
          sizes="100vw"
